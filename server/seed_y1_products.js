...
products.forEach(product => {
    try {
        stmt.run(
            ...
            product.description,
            product.stock,
            JSON.stringify(product.images), // imageUrl alanına images array'i kaydediyoruz
            product.modelUrl,
        ...
        console.error(`✗ ${product.name} eklenemedi:`, error.message);
    }
});

console.log(`\n${successCount}/${products.length} ürün başarıyla veritabanına eklendi.`);
